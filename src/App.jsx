        ...
        <div className="sb3">
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:"1.2rem",alignItems:"stretch"}}>
            {(es?[
              ...
              {plan:"Basic Inquiry",precio:"Free",plazo:"24-48 hrs",icon:"🔍",color:"#6b5240",bg:"white",border:"rgba(107,82,64,.2)",desc:"Initial verification of the land fraction's registry status.",items:["Current registered owner","Mortgages or liens","General encumbrances","WhatsApp response"],cta:"Inquire free",highlight:false},
